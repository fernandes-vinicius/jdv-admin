...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "group-data-[collapsible=icon]:-mt-8 flex h-8 shrink-0 items-center rounded-none px-3 font-semibold text-sidebar-foreground/70 text-xs uppercase tracking-wider outline-hidden ring-sidebar-ring transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 group-data-[collapsible=icon]:opacity-0 [&>svg]:size-3.5 [&>svg]:shrink-0",
        className,
      )}
      {...props}
    />
...
function SidebarGroupAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        "after:-inset-2 absolute top-3.5 right-3 flex aspect-square w-5 items-center justify-center rounded-none p-0 text-sidebar-foreground outline-hidden ring-sidebar-ring transition-transform after:absolute hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 group-data-[collapsible=icon]:hidden md:after:hidden [&>svg]:size-3.5 [&>svg]:shrink-0",
        className,
      )}
      {...props}
    />
...
function SidebarMenuAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        "after:-inset-2 absolute top-1.5 right-1 flex aspect-square w-5 items-center justify-center rounded-none p-0 text-sidebar-foreground outline-hidden ring-sidebar-ring transition-transform after:absolute hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 peer-hover/menu-button:text-sidebar-accent-foreground group-data-[collapsible=icon]:hidden peer-data-[size=default]/menu-button:top-2 peer-data-[size=lg]/menu-button:top-2.5 peer-data-[size=sm]/menu-button:top-1 md:after:hidden [&>svg]:size-3.5 [&>svg]:shrink-0",
        showOnHover &&
