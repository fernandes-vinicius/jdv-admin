...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "[[data-variant=legend]+&]:-mt-1.5 text-left font-normal text-muted-foreground text-sm normal-case leading-normal tracking-normal group-has-data-horizontal/field:text-balance",
